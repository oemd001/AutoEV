...
int trigPin = 9; // Add the Trig pin on pin 10.
int echoPin = 8; // Add the ECHO pin on pin 9.
...
void loop() {
  ...
  if(distance >= 100) { // If no obstacle is there within 30 cm, the Led should turn off.
